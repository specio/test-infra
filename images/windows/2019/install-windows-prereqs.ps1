...
Param(
    [string]$GitURL = 'https://oejenkins.blob.core.windows.net/oejenkins/Git-2.19.1-64-bit.exe',
    ...
    [string]$SevenZipURL = 'https://oejenkins.blob.core.windows.net/oejenkins/7z1806-x64.msi',
    ...
    [string]$VSBuildToolsURL = 'https://oejenkins.blob.core.windows.net/oejenkins/vs_buildtools_2017.exe',
    [string]$VSBuildToolsHash = '',
    [string]$Clang7URL = 'https://oejenkins.blob.core.windows.net/oejenkins/LLVM-7.0.1-win64.exe',
    ...
    [string]$NugetURL = 'https://oejenkins.blob.core.windows.net/oejenkins/nuget-3.4.3.nupkg',
    [string]$NugetHash = '2D4D38666E5C7D27EE487C60C9637BD9DD63795A117F0E0EDC68C55EE6DFB71F',
    [string]$DevconURL = 'https://oejenkins.blob.core.windows.net/oejenkins/devcon_package.cab',
    ...
    [string]$AzureDCAPNupkgURL = 'https://oejenkins.blob.core.windows.net/oejenkins/microsoft.azure.dcap.1.6.0.nupkg',
